...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1900842165:AAF_Cbx3qKvMxZvONEqAeGqlai5crlFy6X4' # Get it from https://t.me/BotFather
    APP_ID = '7891804' # Get it from my.telegram.org/apps
    API_HASH = 'bff1312891e6f4a8ac4eff8670ee3aab' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://pvugaloeoaljju:f44a0f13eaf84f272b903e2ac0b1d91161a3da7725ca508f95c514ad3c69739a@ec2-18-214-195-34.compute-1.amazonaws.com:5432/de723mjqnc4ig0' # SQL Database URL / Heroku Postgres URL
